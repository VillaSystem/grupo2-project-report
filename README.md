...
| 4.1     | 13/11/2024 | Gustavo Huanca    | Implemento el sprint 4 goal                                                                                                               |
| 4.2     | 13/11/2024 | Oscar Armas       | Bounded context batches finalizado en backend                                                                                             |
| 4.3     | 13/11/2024 | Gustavo Huanca    | Bounded context clients finalizado en backend                                                                                             |
| 4.4     | 14/11/2024 | Angelo Curi       | Bounded context inventories finalizado en backend                                                                                         |
| 4.5     | 14/11/2024 | Diego Huincho     | Bounded context orders finalizado en backend                                                                                              |
| 4.9     | 15/11/2024 | Gustavo Huanca    | Bounded context clients terminado en front end                                                                                            |
| 4.11    | 16/11/2024 | Angelo Curi       | Bounded context inventories terminado en front end                                                                                        |
| 4.12    | 17/11/2024 | Oscar Armas       | Bounded context batches terminado en front end                                                                                            |
| 4.13    | 17/11/2024 | Diego Huincho     | Bounded context auth finalizado en backend                                                                                                |
| 4.14    | 17/11/2024 | Fernando Salhuana | Bounded context wines finalizado en backend                                                                                               |
| 4.15    | 18/11/2024 | Gustavo Huanca    | Web service integrado completamente al web application                                                                                    |
| 4.16    | 18/11/2024 | Gustavo Huanca    | Despliegue del webservice y web application completado                                                                                    |
| 4.17    | 18/11/2024 | Angelo Curi       | Web service integrado completamente al web application                                                                                    |
| 4.18    | 18/11/2024 | Oscar Armas       | Implemento el Sprint Planning 4                                                                                                           |
| 4.19    | 18/11/2024 | Oscar Armas       | Services Documentation Evidence for Sprint Review implementada                                                                            |
| 4.21    | 18/11/2024 | Gustavo Huanca    | Execution evidence for sprint 4 implementada                                                                                              |
| 4.22    | 18/11/2024 | Gustavo Huanca    | Software deployment evidence for sprint 4 completado                                                                                      |
...
| Integrante        | Tareas Asignadas                                                                              |
|-------------------|-----------------------------------------------------------------------------------------------|
| Gustavo Huanca    | Execution evidence for sprint 4, Software deployment evidence for sprint 4                    |
| Angelo Curi       | Testing Suite Evidence for Sprint Review, Team Collaboration Insights during Sprint           |
| Oscar Armas       | Implemento el Sprint Planning 4, implemento Services Documentation Evidence for Sprint Review |
| Diego Huincho     | Sprint Backlog, Development Evidence for Sprint Review                                        |
| Fernando Salhuana | Arreglo de los links                                                                          |
...
![TP1](images/report.PNG)

![TP1](images/report2.PNG)
...
|------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Comunica oralmente con efectividad a diferentes ranges de audiencia.   | **Angelo**<br>TB1:<br>He colaborado de manera proactiva en la resolución de desafíos durante la finalización del informe. Al ofrecer soluciones efectivas y facilitar el progreso del proyecto, he asegurado que todos los aspectos importantes se aborden de manera oportuna, lo que ha mejorado la cohesión del equipo.<br>TP:<br>He avanzado en los elementos asignados mediante la coordinación de reuniones grupales diarias y semanales, logrando cumplir con las tareas asignadas y manteniendo al equipo alineado en nuestras metas.<br>TB2:<br>He mantenido comunicación constante con el equipo, participando en reuniones donde aplicamos buenas prácticas de DDD, fortaleciendo el entendimiento mutuo de los objetivos del proyecto.<br>TF:<br>Durante la fase final del proyecto, me aseguré de cumplir con mis responsabilidades de manera autónoma, enfocándome en completar mis tareas con calidad y dentro del plazo establecido. Mi comunicación con el equipo fue constante, participé activamente cuando fue necesario, asegurándome de entender claramente las instrucciones y lineamientos del equipo. Mi capacidad para comunicar mis avances y necesidades de manera clara y puntual contribuyó a que mi trabajo estuviera alineado con los objetivos generales del proyecto, ayudando al progreso del equipo y al cumplimiento de nuestras metas en conjunto.<br><br>**Oscar**<br>TB1:<br>He participado activamente en discusiones clave, aportando ideas sobre problemáticas del proyecto, especialmente en Lean UX Problem Statements, asegurando la alineación del equipo.<br>TP:<br>Utilicé ejemplos claros en presentaciones para facilitar la comprensión de los objetivos del proyecto.<br>TB2:<br>Fomenté un ambiente de diálogo abierto, mejorando las technical stories y el desarrollo del backend.<br>TF:<br>Durante la fase final del proyecto, aseguré una comunicación clara y efectiva en todas las interacciones con el equipo, tanto en reuniones de planificación como en la revisión de entregables. Me enfoqué en transmitir ideas técnicas complejas de forma accesible para todos los miembros, adaptándome a diferentes niveles de comprensión dentro del equipo. Además, mantuve una comunicación continua para coordinar ajustes en las tareas de frontend y backend, asegurando que las funcionalidades estuvieran integradas correctamente. Mi capacidad para escuchar y ofrecer retroalimentación constructiva ayudó a resolver problemas técnicos de manera ágil, contribuyendo al éxito del entregable final.<br><br>**Gustavo**<br>TB1:<br>Coordiné la creación de los repositorios, organizando reuniones sobre el flujo de trabajo de Git y estableciendo ramas para cada repositorio, mejorando el control del proyecto.<br>TP:<br>Logré coordinar la entrega asignando tareas para el avance del sprint, manteniendo el enfoque y cumpliendo los plazos.<br>TB2:<br>Contribuí en la creación del backend, asegurando prácticas de programación y cumplimiento de requisitos del proyecto.<br>TF:<br>En la fase final del proyecto, lideré al equipo manteniendo una comunicación constante y efectiva en reuniones de Discord y en clase. Me aseguré de que todos los miembros comprendieran sus tareas específicas en el desarrollo del backend, comentando claramente qué partes aún necesitaban ajustes y verificando el cumplimiento de cada tarea asignada. Mi comunicación fue clave para resolver dudas rápidamente, asignar tareas de manera clara y dar retroalimentación directa, lo cual mantuvo al equipo alineado y nos permitió cumplir con los objetivos del entregable final.<br><br>**Fernando**<br>TB1:<br>Cumplí con las asignaciones siendo enfático y minucioso en las investigaciones para redactar enunciados que reflejan el progreso del proyecto.<br>TP:<br>Mis intervenciones en reuniones han sido claras y precisas, facilitando la comunicación.<br>TB2:<br>He participado en el intercambio de ideas, optimizando la colaboración.<br>TF:<br>En el final del proyecto, me aseguré de que mi comunicación fuera bastante clara y concisa sobre resolver algunos problemas y dudas que se me presentaban a lo largo de la realización del proyecto. Además de confirmar o no a las reuniones que se pactaron, mi comunicación fue clave para revelar los motivos por los cuales no pude estar presente, así mismo, reflejar ante los miembros una total respuesta oportuna a la situación. Mi capacidad para comunicar me ayudó en pactar con los avances y que todos estuviéramos encaminados con el mismo objetivo de realizar correctamente el trabajo.<br><br>**Diego**<br>TB1:<br>He participado en el desarrollo de prototipos y he mantenido una comunicación efectiva con los clientes, adaptando el enfoque y desarrollando soluciones relevantes.<br>TP:<br>Contribuí en el diseño de entrevistas para recopilar información valiosa, mejorando la comprensión de las expectativas del cliente.<br>TB2:<br>Mis aportes en reuniones ayudaron a identificar oportunidades de mejora en el prototipo, fomentando una colaboración eficaz.<br>TF:<br>En el final del proyecto, me aseguré en cumplir con las tareas que me tocaba y en apoyar a mi equipo en lo que faltaba, para esto tuvimos una buena comunicación tanto en las reuniones como en la revisión de entregables. Además mantuve informado a mi equipo con respecto a lo realizado en el backend, asegurándome de que los endpoints funcionaran correctamente. Mi capacidad para escuchar y realizar mis pendientes a tiempo me ayudó a tener un buen trabajo en equipo.<br><br> | La comunicación oral ha sido efectiva dentro del equipo, permitiendo un intercambio fluido de ideas y una comprensión compartida de los objetivos del proyecto. Se continuará fomentando esta comunicación para mantener la colaboración y el progreso del trabajo. |
| Comunica por escrito con efectividad a diferentes rangos de audiencia. | **Angelo**<br>TB1:<br>Realicé la parte asignada del proyecto de manera satisfactoria, cumpliendo con plazos y estándares esperados. Mis informes han sido claros y concisos, facilitando la comprensión del contenido.<br>TP:<br>La claridad y precisión en mi redacción facilitaron la comprensión de los documentos.<br>TB2:<br>Mis informes reflejaron un enfoque sistemático que contribuyó al progreso del proyecto.<br>TF:<br>Durante la fase final del proyecto, mi comunicación escrita fue puntual y efectiva cuando se presentó la necesidad. Utilicé principalmente Discord y WhatsApp para asegurarme de que mis avances estuvieran claros y alineados con los objetivos del equipo. Mantuve una comunicación constante, cuando faltaba información o surgían dudas, no dudaba en preguntar y buscar soluciones rápidamente. Esto garantizó que mi trabajo cumpliera con los requisitos establecidos y que el equipo avanzara de manera eficiente. Mi capacidad para resolver problemas a través de la comunicación escrita fue fundamental para asegurar que todo estuviera en orden y contribuyera al éxito del proyecto.<br><br>**Oscar**<br>TB1:<br>Redacté documentos clave relacionados con problemáticas y el uso de Lenguaje Ubicuo, estructurando la información de manera clara y precisa.<br>TP:<br>El uso de lenguaje técnico adecuado facilitó la toma de decisiones del equipo.<br>TB2:<br>Mis documentos han servido de referencia, fortaleciendo la cohesión del proyecto.<br>TF:<br>Durante la fase final del proyecto, mi comunicación escrita fue clave para garantizar el flujo de información dentro del equipo. Utilicé herramientas como Discord y WhatsApp para proporcionar actualizaciones detalladas sobre mis avances, compartir observaciones técnicas y coordinar tareas con los demás miembros. Me aseguré de redactar mensajes claros y específicos, ajustándose a las necesidades de diferentes audiencias dentro del equipo. Además, mi capacidad para documentar los cambios y sugerencias en el proyecto ayudó a mantener un registro claro y accesible, facilitando el seguimiento de las tareas y asegurando que todos los miembros trabajaran hacia los mismos objetivos.<br><br>**Gustavo**<br>TB1:<br>Redacté informes técnicos y documentación del proyecto, garantizando claridad para diferentes audiencias y facilitando la coordinación.<br>TP:<br>La estructura lógica de mis documentos permitió una mejor comprensión del proyecto.<br>TB2:<br>Proporcioné retroalimentación escrita que mejoró la calidad del trabajo.<br>TF:<br>En la fase final del proyecto, mantuve una comunicación escrita constante a través de WhatsApp, asegurándome de que cada miembro del equipo estuviera al tanto de sus tareas y cumplieran con los plazos establecidos. Enviaba recordatorios y verificaba el avance de cada uno, resolviendo dudas en tiempo real y proporcionando instrucciones claras. Mi comunicación escrita fue fundamental para alinear al equipo y garantizar que los objetivos del backend y del entregable final se alcanzaran de manera efectiva y puntual.<br><br>**Fernando**<br>TB1:<br>Trabajé en la organización de tareas, mejorando la redacción de capítulos asignados.<br>TP:<br>La planificación previa de mis escritos aseguró la cohesión de los entregables.<br>TB2:<br>Mis informes fueron claros, permitiendo que todos comprendieran las áreas de enfoque.<br>TF:<br>Mi comunicación escrita fue clave para completar los informes finales del proyecto. Utilicé correos electrónicos, mensajes de Discord y WhatsApp para mantener al equipo informado sobre el avance y los puntos que necesitaban atención. Siempre traté de ser claro y conciso, asegurándome de que los entregables fueran coherentes y fáciles de entender por todos los miembros del equipo. Mi capacidad para redactar de manera clara y efectiva ayudó a mantener un flujo constante de información, lo que permitió la correcta finalización del proyecto.<br><br>**Diego**<br>TB1:<br>Redacté el plan de acción y prototipos, asegurando una estructura clara y accesible.<br>TP:<br>Mis documentos ayudaron a crear una base sólida para el desarrollo del proyecto.<br>TB2:<br>Mis informes fueron comprensibles y facilitaron la toma de decisiones.<br>TF:<br>En la fase final del proyecto, mi comunicación escrita también fue esencial. Me aseguré de que todas las tareas estuvieran claramente documentadas y compartidas en las plataformas correspondientes, como Discord y WhatsApp. Mi capacidad para sintetizar información técnica y presentarla de manera sencilla permitió que todos los miembros del equipo pudieran seguir fácilmente las indicaciones y realizar sus tareas de forma eficiente. La comunicación escrita fluida fue esencial para la organización y el progreso continuo del trabajo.<br><br>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | La comunicación escrita fue fundamental para mantener el equipo informado y alineado, permitiendo un flujo de trabajo claro y eficiente. Se continuará promoviendo esta práctica para asegurar que todas las tareas sean ejecutadas con coherencia y puntualidad.   |
...
El Sprint #4 tiene como fecha de inicio el 11/11/2024 y tiene como meta culminar, conectar y desplegar el front end y el
back end de la aplicación en su totalidad.
...
| **Location**                                       | Servidor de Discord del Equipo                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| **Prepared by**                                    | Gustavo Esau Huanca Navarro                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| **Attendees (to planning meeting)**                | Angelo Curi, Oscar Armas, Diego Huincho, Fernando Salhuana                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| **Sprint n – 1 Review Summary**                    | En el Sprint 3, se completó la implementación del frontend de la aplicación, con énfasis en la interfaz de usuario para componentes clave como la gestión de clientes e inventario. Sin embargo, algunos elementos de la interfaz no fueron tan intuitivos como se esperaba, según el feedback inicial de los usuarios, lo que generó oportunidades de mejora en la usabilidad.                                                                                                                                                          |
| **Sprint n – 1 Retrospective Summary**             | En la retrospectiva del Sprint 3, el equipo reconoció la necesidad de mejorar la comunicación entre diseño y desarrollo para asegurar que los elementos de la interfaz cumplan con los estándares de usabilidad. También se decidió aumentar el tiempo de pruebas de usuario en la fase de desarrollo.                                                                                                                                                                                                                                   |
| **Sprint n – 2 Review Summary**                    | En el Sprint 4, se propuso continuar el desarrollo de los detalles del front end de la aplicación, y desplegar una primera versión del back end con endpoints funcionales. Se evidencia que el equipo logró cumplir con los objetivos propuestos.                                                                                                                                                                                                                                                                                        |
| **Sprint n – 2 Retrospective Summary**             | Investigar sobre testing y documentarlo de manera apropiada. Revisar las user stories y reestructurarlas para que todos los developers comprendan con simplicidad su propósito.                                                                                                                                                                                                                                                                                                                                                          |
| **Sprint n – 3 Review Summary**                    | En el Sprint 3, se completó la implementación del frontend de la aplicación, con énfasis en la interfaz de usuario para componentes clave como la gestión de clientes e inventario. Sin embargo, algunos elementos de la interfaz no fueron tan intuitivos como se esperaba, según el feedback inicial de los usuarios, lo que generó oportunidades de mejora en la usabilidad.                                                                                                                                                          |
| **Sprint n – 3 Retrospective Summary**             | En la retrospectiva del Sprint 3, el equipo reconoció la necesidad de mejorar la comunicación entre diseño y desarrollo para asegurar que los elementos de la interfaz cumplan con los estándares de usabilidad. También se decidió aumentar el tiempo de pruebas de usuario en la fase de desarrollo.                                                                                                                                                                                                                                   |
| **Sprint Goal & User Stories**                     |
| **Sprint 4 Goal**                                  | Our goal in this sprint was to resolve outstanding issues related to wines and batches, as well as implement backend functionalities for PUT and DELETE operations on batches, wines, customers, inventory and orders entities. Upon completion, we managed to stabilize the system, improve its functionality and ensure that all requests are handled efficiently. This confirms that we have met the stated objectives, delivering a complete and functional web application that meets the needs of wine producers and distributors. |
...
| URL                                                                                                                         | Endpoint                          | HTTP Verb | Acción Implementada                              | Sintaxis de Llamada                                                                      | Parámetros Posibles                                           | Ejemplo de Response                                                       | Explicación del Response                                            |
|-----------------------------------------------------------------------------------------------------------------------------|-----------------------------------|-----------|--------------------------------------------------|------------------------------------------------------------------------------------------|---------------------------------------------------------------|---------------------------------------------------------------------------|---------------------------------------------------------------------|
| https://backend-villasystem-production-36d5.up.railway.app/swagger-ui/index.html#/Clients/updateClient                      | /api/v1/clients/{clientId}        | PUT       | Actualizar datos de los clientes                 | 'accept: application/json'                                                               | Ninguno                                                       | `[{"id": 1, "firstName": "John", "lastName": "Doe", ...}]`                | Retorna un array de objetos cliente                                 |
| https://backend-villasystem-production-36d5.up.railway.app/swagger-ui/index.html#/Clients/deleteClient                      | /api/v1/clients/{clientId}        | DELETE    | Eliminar un cliente                              | 'accept: */*'                                                                            | `clientId` (path parameter)                                   | `{}`                                                                      | Retorna un objeto vacío si el cliente fue eliminado exitosamente    |
| https://backend-villasystem-production-36d5.up.railway.app/swagger-ui/index.html#/Inventories/updateInventory               | /api/v1/inventories/{inventoryId} | PUT       | Actualizar un ítem de inventario                 | 'Content-Type: application/json' -d '{"name": "Wine Bottle", "type": "Glass", ...}'      | `inventoryId` (path parameter), JSON con datos del inventario | `{"id": 5, "name": "Wine Bottle", "type": "Glass", ...}`                  | Retorna el objeto inventario actualizado                            |
| https://backend-villasystem-production-36d5.up.railway.app/swagger-ui/index.html#/Inventories/deleteInventoryItem           | /api/v1/inventories/{inventoryId} | DELETE    | Eliminar un ítem de inventario                   | 'accept: */*'                                                                            | `inventoryId` (path parameter)                                | `{}`                                                                      | Retorna un objeto vacío si el inventario fue eliminado exitosamente |
| https://backend-villasystem-production-36d5.up.railway.app/swagger-ui/index.html#/Batch/updateBatchItem                     | /api/v1/batches/{batchId}         | PUT       | Actualizar datos de un lote                      | 'Content-Type: application/json' -d '{"batchNumber": "B003", "grape": "Syrah", ...}'     | `batchId` (path parameter), JSON con datos del lote           | `{"id": 1, "batchNumber": "B003", "grape": "Syrah", ...}`                 | Retorna el objeto lote actualizado                                  |
| https://backend-villasystem-production-36d5.up.railway.app/swagger-ui/index.html#/Batch/deleteBatchItem                     | /api/v1/batches/{batchId}         | DELETE    | Eliminar un lote específico por su ID            | DELETE /api/v1/batches/{batchId}                                                         | `batchId` (path parameter)                                    | `{}`                                                                      | Confirma eliminación exitosa.                                       |


- Bounded Context Clients: Hemos creado los endpoints de los clientes teniendo put y delete por id.
  ![](images/evidence-back/clients-put.png)
  ![](images/evidence-back/clients-delete.png)


- Bounded Context Inventories: Hemos creado los endpoints de inventories teniendo put y delete por id.
  ![](images/evidence-back/inventories-put.png)
  ![](images/evidence-back/inventories-delete.png)

- Bounded Context Batches: Hemos creado los endpoints de batch teniendo put y delete por id.
  ![](images/evidence-back/batches-put.png)
  ![](images/evidence-back/batches-delete.png)

- Bounded Context wine: Hemos creado los endpoints de wine teniendo put y delete por id.
...
Link del frontend desplegado: https://grape-flow.vercel.app/
