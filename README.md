...
|---------|-------------------------------------------------------|------------------------------------------------------------------------------------------------|
| EP01    | Registro de Datos del Producto                        | Permite a los productores registrar los datos esenciales de sus productos.                     |
| EP02    | Visualización de Información del Producto             | Permite a los consumidores visualizar información detallada sobre los productos.               |
| EP03    | Gestión de Inventarios                                | Facilita la gestión de inventarios para los productores y distribuidores.                      |
| EP04    | Monitoreo de Parámetros Críticos                      | Permite a los productores monitorear parámetros clave como pH y temperatura.                   |
| EP05    | Automatización de Procesos de Producción              | Automatiza ciertos procesos de producción para mejorar la eficiencia.                          |
| EP06    | Configuración de Alertas de Producción                | Permite configurar alertas para el seguimiento de los productos durante la producción.         |
| EP07    | Registro de Equipamiento de Producción                | Facilita el registro de maquinaria y equipamiento usado en la producción.                      |
| EP08    | Generación de Reportes Personalizados                 | Permite la generación de reportes personalizados sobre la producción y distribución.           |
| EP09    | Gestión de Perfiles de Usuarios                       | Permite a los administradores gestionar los perfiles de los usuarios del sistema.              |
| EP10    | Configuración de Alertas por Vencimiento de Productos | Permite configurar alertas para notificar a los productores sobre productos próximos a vencer. |
| EP11    | Gestión de Ambientes y Recursos                       | Facilita la gestión de ambientes y recursos asociados a la producción.                         |
| EP12    | Optimización del Uso de Recursos                      | Permite optimizar el uso de recursos en el proceso productivo.                                 |
